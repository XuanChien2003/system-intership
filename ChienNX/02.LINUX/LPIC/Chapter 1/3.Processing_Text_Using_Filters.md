# PROCESSING TEXT USING FILTERS (XỬ LÝ VĂN BẢN SỬ DỤNG BỘ LỌC)
...
### Numbering with nl (Đánh số với nl)
...
### Pulling out portions with cut (Trích xuất các phần với cut)
...
### Discovering Repeated Lines with `uniq` (Phát hiện các dòng trùng lặp với `uniq`)
...
### Digesting an MD5 Algorithm (Băm bằng thuật toán MD5)
...
### Securing Hash Algorithms (Bảo mật bằng các thuật toán băm)

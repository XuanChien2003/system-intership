# MANAGING PROCESS (QUẢN LÝ TIẾN TRÌNH)
## Examining Process Lists (Kiểm tra danh sách tiến trình)

### Viewing Processes with ps (Xem các tiến trình với ps)
...
### Understanding Process States (Hiểu về các trạng thái tiến trình) 
...
### Selecting Processes with ps (Chọn các tiến trình với ps) 
...
## Understanding Foreground and Background Processes (Hiểu về tiến trình chạy nổi và chạy nền)
### Sending a Job to the Background (Đưa một tác vụ vào chạy nền)
...
### Sending Multiple Jobs to the Background (Đưa nhiều tác vụ vào chạy nền)
...
### Bringing Jobs to the Foreground (Đưa tác vụ lên chạy nổi)
...
### Sending a Running Program to the Background (Đưa chương trình đang chạy vào nền)
...
### Stopping a Job (Dừng một tác vụ)
...
## Managing Process Priorities (Quản lý mức độ ưu tiên của tiến trình)

# MANAGING SHARED LIBRARIES (QUẢN LÝ THƯ VIỆN CHIA SẺ)
## Library Principles (Các nguyên tắc về thư viện)
...
## Locating Library Files (Xác định vị trí các file thư viện)
...
## Loading Dynamically (Nạp thư viện động)
...
## Library Management Commands (Các lệnh quản lý thư viện)
### Managing the Library Cache (Quản lý bộ nhớ cache của thư viện)
...
### Troubleshooting Shared Library Dependencies (Khắc phục lỗi phụ thuộc thư viện chia sẻ)

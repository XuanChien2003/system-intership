...
Subnet là phương pháp chia một mạng lớn thành nhiều mạng nhỏ hơn (gọi là mạng con - Subnet) để dễ quản lý, tăng hiệu suất và nâng cao bảo mật.

**Ví dụ:**
Một công ty có mạng 192.168.1.0/24 với khoảng 254 thiết bị. Để dễ quản lý, công ty có thể chia thành các mạng con:

- 192.168.1.0/26 cho phòng Kế toán
- 192.168.1.64/26 cho phòng Nhân sự
- 192.168.1.128/26 cho phòng Kỹ thuật
- 192.168.1.192/26 cho phòng Kinh doanh

Mỗi phòng ban sẽ hoạt động trên một mạng con riêng biệt.

---

**Subnet Mask**

Subnet Mask là một thành phần quan trọng của địa chỉ IP, thường được biểu diễn dưới dạng các số thập phân ngăn cách bởi dấu chấm (ví dụ: 255.255.255.0). Nó được sử dụng để xác định phần nào của địa chỉ IP là địa chỉ mạng (Network) và phần nào là địa chỉ thiết bị (Host).

Trong Subnet Mask:

- Bit 1 biểu thị phần mạng (Network).
- Bit 0 biểu thị phần thiết bị (Host).
...
Dạng nhị phân của Subnet Mask:

11111111.11111111.11111111.00000000

Ba octet đầu (192.168.1) là phần mạng, octet cuối (10) là phần thiết bị.

=> Thiết bị có IP 192.168.1.10 thuộc mạng 192.168.1.0.

---

**Số Prefix**

Để mô tả địa chỉ IP ngắn gọn hơn, người ta sử dụng số Prefix. Prefix chính là số lượng bit 1 liên tiếp trong Subnet Mask và được viết sau địa chỉ IP, ngăn cách bởi dấu "/".
...
Có tổng cộng 24 bit 1 nên Prefix là:

/24

Do đó địa chỉ IP có thể được viết:

192.168.1.10/24

Điều này có nghĩa là địa chỉ IP 192.168.1.10 có 24 bit dành cho phần mạng và 8 bit dành cho phần thiết bị.
